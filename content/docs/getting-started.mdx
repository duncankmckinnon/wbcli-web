...
> **Plan frontmatter (optional):** Plans can declare run-time defaults in a YAML frontmatter block at the very top of the file, before `# Title`. CLI flags always override frontmatter values. See [Plan Frontmatter](/docs/plan-format#plan-frontmatter-run-config) for the full schema and examples.
>
> ````markdown
> ---
...
- **[Agents](/docs/agents)** — configure multi-provider setups with Claude, Gemini, Codex, Cursor, and Copilot
