...
Create `.workbench/agents.yaml` pre-populated with configs for all built-in adapters (Claude, Gemini, Codex, Cursor). Use as a starting point for customization.
