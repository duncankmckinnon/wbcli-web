...
Create `agents.yaml` pre-populated with configs for all built-in adapters (Claude, Antigravity, Codex, Cursor, Copilot). Use as a starting point for customization.
